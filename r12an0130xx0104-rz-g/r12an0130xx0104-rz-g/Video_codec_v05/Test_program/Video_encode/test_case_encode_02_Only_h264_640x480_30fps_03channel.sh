...
branch. ! queue ! omxh264enc use-dmabuf=true target-bitrate=4000000 ! video/x-h264,profile=\(string\)main,level=\(string\)3 ! h264parse ! qtmux ! filesink location=video_data/h264_Only_enc_YUV420_planar_Main_Profile_Level_3_640x480_4Mbits_30fps_60seconds.mp4 name=v03 -rp v03:sink > /tmp/log_encode_h264_640x480_30fps_03channel_03.txt
 
#Use videotestsrc
#gst-launch-1.0 -r videotestsrc num-buffers=1800 is-live=true ! video/x-raw,width=640,height=480,format=NV12,framerate=30/1 ! omxh264enc target_bitrate=4000000 ! video/x-h264,profile=\(string\)main,level=\(string\)3,alignment=au ! queue ! filesink location=video_data/_Videotestsrc_h264_Only_enc_YUV420_planar_Main_Profile_Level_3_640x480_4Mbits_30fps_60seconds.mp4 name=v -rp v:sink > /tmp/log_encode_videotestsrc_h264_640x480_30fps_03channel_01.txt &
 
#Use videotestsrc
#gst-launch-1.0 -r videotestsrc num-buffers=1800 is-live=true ! video/x-raw,width=640,height=480,format=NV12,framerate=30/1 ! omxh264enc target_bitrate=4000000 ! video/x-h264,profile=\(string\)main,level=\(string\)3,alignment=au ! queue ! filesink location=video_data/_Videotestsrc_h264_Only_enc_YUV420_planar_Main_Profile_Level_3_640x480_4Mbits_30fps_60seconds.mp4 name=v -rp v:sink > /tmp/log_encode_videotestsrc_h264_640x480_30fps_03channel_02.txt &
 
#Use videotestsrc
#gst-launch-1.0 -r videotestsrc num-buffers=1800 is-live=true ! video/x-raw,width=640,height=480,format=NV12,framerate=30/1 ! omxh264enc target_bitrate=4000000 ! video/x-h264,profile=\(string\)main,level=\(string\)3,alignment=au ! queue ! filesink location=video_data/_Videotestsrc_h264_Only_enc_YUV420_planar_Main_Profile_Level_3_640x480_4Mbits_30fps_60seconds.mp4 name=v -rp v:sink > /tmp/log_encode_videotestsrc_h264_640x480_30fps_03channel_03.txt &
