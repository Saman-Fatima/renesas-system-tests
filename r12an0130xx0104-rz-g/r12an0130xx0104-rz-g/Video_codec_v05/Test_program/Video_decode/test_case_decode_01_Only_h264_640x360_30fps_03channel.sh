...
echo -n "${Board_name},h264,640x360,30fps,3," >> ${output_dir}/${test_dir}/output.csv
...
#Step09: Gst pipeline
sync
gst-launch-1.0 -r filesrc location=./video_data/h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_640x360_30fps_03channel_01.txt &
...
#gst-launch-1.0 -r filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_640x360_30fps_03channel_01.txt &
gst-launch-1.0 -r filesrc location=./video_data/h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_640x360_30fps_03channel_02.txt &
 
#use with filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4
#gst-launch-1.0 -r filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_640x360_30fps_03channel_02.txt &
gst-launch-1.0 -r filesrc location=./video_data/h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_640x360_30fps_03channel_03.txt &
 
#use with filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4
#gst-launch-1.0 -r filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_2.1_640x360_Progressive_1.5Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_640x360_30fps_03channel_03.txt &
