...
echo -n "${Board_name},h264,1280x720,30fps,4," >> ${output_dir}/${test_dir}/output.csv
...
#Step09: Gst pipeline
sync
gst-launch-1.0 -r filesrc location=./video_data/h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_01.txt &
...
#gst-launch-1.0 -r filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_01.txt &
gst-launch-1.0 -r filesrc location=./video_data/h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_02.txt &
 
#use with filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4
#gst-launch-1.0 -r filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_02.txt &
gst-launch-1.0 -r filesrc location=./video_data/h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_03.txt &
 
#use with filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4
#gst-launch-1.0 -r filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_03.txt &
gst-launch-1.0 -r filesrc location=./video_data/h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_04.txt &
 
#use with filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4
#gst-launch-1.0 -r filesrc location=./video_data/Videotestsrc_h264_Only_dec_YUV420_planar_Main_Profile_Level_3.1_1280x720_Progressive_4Mbits_30fps_60seconds.mp4 ! qtdemux ! h264parse ! omxh264dec ! waylandsink max-lateness=-1 qos=false name=v -rp v:sink > /tmp/log_decode_h264_1280x720_30fps_04channel_04.txt &
